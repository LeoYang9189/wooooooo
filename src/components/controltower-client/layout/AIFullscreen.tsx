...
const AIFullscreen: React.FC<AIFullscreenProps> = ({ visible, onClose, onExitFullscreen }) => {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      setAiMessages(prev => [...prev, {
        text: `我已收到你的问题："${fullInput}"。作为智能客服助手，我正在为你查询处理，请稍候...`,
        isUser: false
      }]);
      setUserInput('');
      setSkillPrefix('');
  ...
  const handleExampleClick = (question: string) => {
    ...
    setTimeout(() => {
      setAiMessages(prev => [...prev, {
        text: `我已收到你的问题："${question}"。作为智能客服助手，我正在为你查询处理，请稍候...`,
        isUser: false
      }]);
    }, 500);
  };
  ...
  const moreMenuDroplist = (
    ...
    >
      <Menu.Item key="订单查询">订单查询</Menu.Item>
      <Menu.Item key="货物追踪">货物追踪</Menu.Item>
      <Menu.Item key="发票申请">发票申请</Menu.Item>
      <Menu.Item key="费用查询">费用查询</Menu.Item>
    </Menu>
  );
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center mr-4 shadow-md">
                  <img src="/assets/g6qmm-vsolk.gif" alt="智能客服助手" className="w-full h-full object-cover" />
                </div>
                <div>
                  <div className="text-xl font-medium bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                    智能客服助手
                  </div>
                  <div className="text-sm text-purple-600">你的物流，可以更简单</div>
                </div>
              </div>
          ...
          <div className="w-80 bg-white/80 backdrop-blur-sm border-r border-purple-200/50 p-4 overflow-y-auto">
            ...
            <div className="space-y-2">
              ...
              <div className="p-3 rounded-lg bg-gray-50 border border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors">
                <div className="text-sm text-gray-700">查询我的订单CT1234567最新状态</div>
                <div className="text-xs text-gray-500 mt-1">10分钟前</div>
              </div>
              <div className="p-3 rounded-lg bg-gray-50 border border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors">
                <div className="text-sm text-gray-700">上海到洛杉矶海运费是多少？</div>
                ...
                {aiMessages.length === 0 && (
                  <div className="flex mb-6">
                    ...
                    <div className="flex-1">
                      <div className="mb-3">
                        <span className="text-lg text-purple-600 font-medium">👋 你好，我是智能客服助手</span>
                      </div>
                      <div className="text-gray-700 leading-relaxed mb-4">
                        你好，我是你的物流AI助理。我可以帮你处理订单查询、运价查询、货物追踪、状态查看、发票申请等问题，让你的物流体验更加便捷高效！
                      </div>
                      ...
                      <div className="mt-6">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div 
                            ...
                            onClick={() => handleExampleClick('查询我的订单CT1234567最新状态')}
                          >
                          ...
                          <div 
                            className="p-4 flex items-center cursor-pointer bg-white hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 rounded-xl transition-all border border-purple-200 shadow-sm hover:shadow-md min-h-[80px]"
                            onClick={() => handleExampleClick('上海到洛杉矶海运费是多少？')}
                          >
                            <span className="text-purple-500 mr-3 text-lg">›</span>
                          ...
                          <div 
                            className="p-4 flex items-center cursor-pointer bg-white hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 rounded-xl transition-all border border-purple-200 shadow-sm hover:shadow-md min-h-[80px]"
                            onClick={() => handleExampleClick('我的货物CT121212现在到哪里了？')}
                          >
                            <span className="text-purple-500 mr-3 text-lg">›</span>
                          ...
                          <div 
                            className="p-4 flex items-center cursor-pointer bg-white hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 rounded-xl transition-all border border-purple-200 shadow-sm hover:shadow-md min-h-[80px]"
                            onClick={() => handleExampleClick('帮我创建一个新的运输询价')}
                          >
                            <span className="text-purple-500 mr-3 text-lg">›</span>
              ...
              <div className="max-w-4xl mx-auto p-6">
                ...
                <div className="flex items-center gap-6 justify-center mb-4">
                  <Button 
                    ...
                    onClick={() => handleQuickAction('订单查询')}
                  >
                    订单查询
                  </Button>
                  <Button 
                  ...
                  <Button 
                    ...
                    onClick={() => handleQuickAction('货物追踪')}
                  >
                    货物追踪
                  </Button>
                  <Button 
                    ...
                    onClick={() => handleQuickAction('在线询价')}
                  >
                    在线询价
                  </Button>
                  ...
                  >
                    ...
                    <div className="relative">
                      <Input.TextArea
                        ...
                        placeholder={skillPrefix ? "继续输入你的具体需求..." : "需要我帮你查询什么信息呢？"}
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-lg bg-gradient-to-r from-blue-50 to-purple-50 border border-purple-200 hover:shadow-md transition-shadow cursor-pointer">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-purple-700 mb-2">订单管理</h4>
                    <p className="text-sm text-gray-600">快速查询订单状态，跟踪货物运输进度</p>
                  </div>
                </div>
              </div>
              <div className="p-4 rounded-lg bg-gradient-to-r from-pink-50 to-purple-50 border border-pink-200 hover:shadow-md transition-shadow cursor-pointer">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-pink-700 mb-2">运价查询</h4>
                    <p className="text-sm text-gray-600">实时查询最新运价信息，获取优惠报价</p>
                  </div>
                </div>
              </div>
              <div className="p-4 rounded-lg bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 hover:shadow-md transition-shadow cursor-pointer">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-indigo-700 mb-2">物流追踪</h4>
                    <p className="text-sm text-gray-600">实时追踪货物位置，掌握运输动态</p>
                  </div>
                </div>
              </div>
              <div className="p-4 rounded-lg bg-gradient-to-r from-green-50 to-purple-50 border border-green-200 hover:shadow-md transition-shadow cursor-pointer">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-green-700 mb-2">在线客服</h4>
                    <p className="text-sm text-gray-600">7x24小时在线服务，解答各类物流问题</p>
                  </div>
                </div>
              </div>
            </div>
