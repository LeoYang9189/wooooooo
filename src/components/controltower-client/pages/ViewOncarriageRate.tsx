...
运价编号：${rateData.code}
目的港：${rateData.origin}
配送地址类型：${rateData.addressType}
${rateData.addressType === '第三方地址' ? 
  `邮编：${rateData.zipCode}\n地址：${rateData.address}` : 
  `仓库代码：${rateData.warehouseCode}`}
代理名称：${rateData.agentName}
        ...
        <div className="space-y-4" style={{ height: '600px', overflow: 'auto' }}>
          ...
          <div className="bg-white p-8 shadow-sm border" style={{ fontFamily: 'SimSun, serif' }}>
            <div className="text-center mb-8">
              <h1 className="text-2xl font-bold mb-2">尾程运价报价单</h1>
              <p className="text-gray-600">Quotation for Oncarriage Rate</p>
            </div>
            ...
            <div className="mb-6">
              ...
              <Row gutter={[16, 8]}>
                ...
                <Col span={8}>目的港：{rateData.origin}</Col>
                <Col span={8}>状态：{rateData.status}</Col>
                <Col span={8}>配送地址类型：{rateData.addressType}</Col>
                {rateData.addressType === '第三方地址' ? (
                  <>
                    <Col span={8}>邮编：{rateData.zipCode}</Col>
                    <Col span={16}>地址：{rateData.address}</Col>
                  </>
                ) : (
                  <Col span={8}>仓库代码：{rateData.warehouseCode}</Col>
                )}
                <Col span={8}>代理名称：{rateData.agentName}</Col>
              </Row>
            </div>
            ...
            <div className="mb-6">
              <div className="bg-orange-50 px-4 py-2 mb-3 rounded">
                <h3 className="text-lg font-semibold text-orange-800">尾程运输费明细</h3>
              </div>
                ...
                <Row gutter={[16, 8]}>
                  <Col span={12}>
                    <div className="text-lg">
                      <span className="text-gray-600">尾程运输费总计：</span>
